...
<body>
    ...
    <form action="" method="POST" enctype="multipart/form-data" class="text-center">
        <div class="form-outline mb-4">
            <input type="text" class="m-auto form-control w-50" name="user_username" value="<?php echo $username ?>">
        </div>
        <div class="form-outline mb-4">
            <input type="email" class="m-auto form-control w-50" name="user_email" value="<?php echo $user_email ?>">
        </div>
        ...
        <div class="form-outline mb-4">
            <input type="text" class="m-auto form-control w-50" name="user_mobile" value="<?php echo $user_mobile ?>">
        </div>
        <input type="submit" class="btn btn-success py-2 px-3 mb-4" value="Update" name="user_update">
    </form>
